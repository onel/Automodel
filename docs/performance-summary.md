...
Pre-training benchmark configurations are available in [`examples/benchmark/configs/`](https://github.com/NVIDIA-NeMo/Automodel/tree/main/examples), while LoRA/fine-tuning configurations are in [`examples/llm_finetune/`](https://github.com/NVIDIA-NeMo/Automodel/tree/main/examples) subdirectories organized by model:
